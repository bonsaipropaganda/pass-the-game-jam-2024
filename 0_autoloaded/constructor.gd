...
@export var TILE_HOVER_RECT:PackedScene = preload("res://ui/terrain/tile_hover_rect.tscn")
#---------------------------------------------------------------------------------------------------
@export var _TERRAIN:PackedScene = preload("res://terrain/terrain.tscn")
func instance_terrain(coord:Vector2i, type:E.TerrainType) -> Terrain:
	...
	return new_terrain
#---------------------------------------------------------------------------------------------------
@export var _ENEMY_GOBLIN:PackedScene = preload("res://entities/enemies/enemy_goblin.tscn")
func instance_enemy_goblin(coord:Vector2i) -> EnemyGoblin:
	...
	return new_goblin
#---------------------------------------------------------------------------------------------------
@export var _ENEMY_SLIME:PackedScene = preload("res://entities/enemies/enemy_slime.tscn")
func instance_enemy_slime(coord:Vector2i) -> EnemySlime:
	...
	return new_slime
#---------------------------------------------------------------------------------------------------
@export var _ENEMY_BAT:PackedScene = preload("res://entities/enemies/enemy_bat.tscn")
func instance_enemy_bat(coord:Vector2i) -> EnemyBat:
	var new_bat:EnemyBat = _ENEMY_BAT.instantiate()
	new_bat.construct(coord)
	return new_bat
#---------------------------------------------------------------------------------------------------
@export var _HERO_PALADIN:PackedScene = preload("res://entities/heroes/hero_paladin.tscn")
func instance_hero_paladin(coord:Vector2i) -> HeroPaladin:
	...
	return new_paladin
#---------------------------------------------------------------------------------------------------
@export var _HERO_ROGUE:PackedScene = preload("res://entities/heroes/hero_rogue.tscn")
func instance_hero_rogue(coord:Vector2i) -> HeroRogue:
	...
	return new_rogue
#---------------------------------------------------------------------------------------------------
@export var _HERO_WIZARD:PackedScene = preload("res://entities/heroes/hero_wizard.tscn")
func instance_hero_wizard(coord:Vector2i) -> HeroWizard:
	...
	return new_wizard
#---------------------------------------------------------------------------------------------------
@export var _ENTITY_EXIT_DOOR:PackedScene = preload("res://entities/grid entities/test room/exit_door.tscn")
...
@export var TEST_MAP:PackedScene = preload("res://places/test map/test_map.tscn")
